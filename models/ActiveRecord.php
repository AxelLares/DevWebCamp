...
class ActiveRecord {
    ...
    public static function paginar($por_paginas, $offset) {
        $query = "SELECT * FROM " . static::$tabla . " ORDER BY id DESC LIMIT ${por_paginas} OFFSET ${offset}" ;
        $resultado = self::consultarSQL($query);
        return $resultado ;
    }
    ...
    // Busqueda Where con muliples opciones 
